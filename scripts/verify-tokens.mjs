...
const lightMap = [
  ...
  ['--warning-bg', tokens.status.warning.bg], ['--warning-text', tokens.status.warning.text],
  ['--warning-border', tokens.status.warning.border],
...
const darkMap = [
  ...
  ['--rm-dark-warning-bg', darkTokens.status.warning.bg],
  ['--rm-dark-warning-text', darkTokens.status.warning.text],
  ['--rm-dark-warning-border', darkTokens.status.warning.border],
